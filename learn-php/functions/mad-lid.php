...
function generateStory($singular_noun, $verb, $color, $distance_unit) {
  // Create a variable $story and assign it the last stanza of Robert Frost’s “Stopping by Woods on a Snowy Evening”. 
  // Use newlines (\n) to ensure the lines break in the right location. 
  // Within the function, change the $story string so that it parses the $singularNoun variable where the word wood currently is,
  // $verb where the word sleep appears (both locations), and $color where dark appears.
